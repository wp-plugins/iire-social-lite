...
<style>
	div#viewport { width:auto; min-width:680px; min-height:235px; height:auto; padding:10px; background-color:#EDEDED; position:relative; top:0px; left:0px; background-image: url('<?php echo IIRE_SOCIAL_LITE_URL ?>/includes/images/preview_widget.png'); background-repeat:no-repeat; background-position: top right;}
...
<h2>iiRe Social Lite - Widget Settings</h2>
...
<div id="iire_social_panel_right">	<!-- START RIGHT PANEL -->
	...
	<div id="right_panel">	<!-- Start Right Panel Container -->
		...
		<div>
			...
			<p><img class="icon_theme" src="<?php echo IIRE_SOCIAL_LITE_URL; ?>themes/<?php echo $settings['widget_icon_theme']; ?>/screenshot.png" width="185" border="0" /></p>
		</div>
	...
	<div id="chooseicons">
		<ul id="chooseicons">
			...
			<li class="choose <?php echo $th; ?>" id="iire-googleplus" alt="http://google.com" title="Google +" lang=""></li>	
...
<li>Add the "iiRe Social Lite" to a sidebar widget area and "Save".</li>
<li>Go to "iiRe Social Lite", "Widget Settings".</li>
